...
.score-0 {
        ...
        /* Styles pour l'animation du fond */
        body.score-0 {
...
$resultat = mysqli_query($conn, "SELECT * FROM reponses where titre='pays'");
...
// Affichage du score
echo "<div><h2>Votre score</h2> <br> " . $score."<br><a href='affich_rep.php'>
